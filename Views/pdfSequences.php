<?php
   ...
   session_start();
    ...
    $stmt = $db->query("SELECT sequence.nom, acteur.nom_acteur,acteur.nom_personnage,costume.numero_costume FROM sequence,acteur,costume,seq_act_cost WHERE seq_act_cost.id_seq = '".$_GET['idseq']."' and  seq_act_cost.id_seq = sequence.id and seq_act_cost.id_act =acteur.id ");
