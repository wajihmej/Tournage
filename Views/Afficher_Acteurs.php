...
$liste=$acteurC->afficherActeursProjet($id);
...
$folder = "./images/Acteurs/".$filename ;
move_uploaded_file($tempname, $folder);


$acteur=new Acteur($_POST['nomac'],$_POST['nomperso'],$_POST['contact'],$_POST['menh'],$_POST['menb'],$_POST['pointure'],$folder,$id);
                ...
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      ...
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">mensuration haut</th>
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">mensuration bas</th>
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">pointure chaussures</th>
                  ...
                  <?php
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <div class="d-flex flex-column justify-content-center">
                            <h6 class="mb-0 text-sm"><?php echo $row['nom_acteur']; ?></h6>
                          </div>
                        </div>
                      </td>
                      <td>
                      ...
                      <td>
                        <div class="avatar-group mt-2">
                        <div class="d-flex flex-column justify-content-center">
                            <h6 class="mb-0 text-sm"><?php echo $row['Contact']; ?></h6>
                          </div>
                        </div>
                      </td>
                      <td>
                        <div class="avatar-group mt-2">
                        <div class="d-flex flex-column justify-content-center">
                            <h6 class="mb-0 text-sm"><?php echo $row['Mensuration_haut']; ?></h6>
                          </div>
                        </div>
                      </td>
                      <td>
                        <div class="avatar-group mt-2">
                        <div class="d-flex flex-column justify-content-center">
                            <h6 class="mb-0 text-sm"><?php echo $row['mensuration_bas']; ?></h6>
                          </div>
                        </div>
                      </td>
                      <td>
                        <div class="avatar-group mt-2">
                        <div class="d-flex flex-column justify-content-center">
                            <h6 class="mb-0 text-sm"><?php echo $row['pointure_chaussures']; ?></h6>
                          </div>
                        </div>
                      </td>
                      <td>
                        <div class="avatar-group mt-2">
                        <div class="d-flex flex-column justify-content-center">
                        <img src="<?php echo $row['image']; ?>" heigth="200" width=150>
                          </div>
                        </div>
                      </td>
          ...
          <div class="card h-100">
            ...
            <div class="card-body p-3">
                ...
                <div class="input-group input-group-outline my-3">
                        ...
                        <input type="text" class="form-control" name="nomac">
                    </div>
                    <div class="input-group input-group-outline my-3">
                    ...
                    <div class="input-group input-group-outline my-3">
                        <label class="form-label">mensuration haut</label>
                        <input type="text" class="form-control" name="menh">
                    </div>
                    <div class="input-group input-group-outline my-3">
                        <label class="form-label">Mensuration bas</label>
                        <input type="text" class="form-control" name="menb">
                    </div>
                    <div class="input-group input-group-outline my-3">
                        <label class="form-label">Pointure chaussures</label>
