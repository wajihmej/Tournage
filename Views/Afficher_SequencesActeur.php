...
$proj= new ProjetC();
    ...
    if (isset($_GET['idAct'])){
        $rst=$acteurC->recupererActeur($_GET['idAct']);
        foreach($rst as $roww){
        $nomAct=$roww['nom_acteur'];
...
$liste=$sequenceC->afficherSelectionnerAct($_GET['idAct']);
...
header('Location: Afficher_SequencesActeur.php?id='.$id.'&idAct='.$_POST['idselect']);
            ...
            <div class="card-header pb-0">
              <div class="row">
                <div class="col-lg-6 col-7">
                  <h6>Sequences Acteur : <?php echo $nomAct ?> / Personnage : <?php echo $nomPerso ?> </h6>
                </div>
              </div>
            </div>
